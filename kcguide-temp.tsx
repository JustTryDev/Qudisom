  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <h1 style={styles.title}>KC인증 가이드</h1>
        <p style={styles.subtitle}>
          인형 제작 시 알아야 할 KC인증의 모든 것
        </p>
      </div>
          ...
          <div style={styles.accordionContent}>
            ...
            <div style={styles.tableContainer}>
              ...
              <div style={styles.tableHeader}>
                <span style={styles.tableHeaderCell}>사용 연령</span>
                <span style={styles.tableHeaderCell}>KC 인증</span>
                <span style={styles.tableHeaderCell}>비용</span>
                <span style={styles.tableHeaderCell}>기간</span>
              </div>
        ...
        {openSection === "labeling" && (
          <div style={styles.accordionContent}>
            ...
            <div style={styles.labelingSection}>
              ...
              <div style={styles.labelingList}>
                {basicLabelingItems.map((item, index) => (
                  <div key={index} style={styles.labelingListItem}>
                    <span style={styles.labelingItemName}>{item.name}</span>
                    <span style={styles.labelingItemExample}>{item.example}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={styles.labelingSectionKC}>
              <div style={styles.labelingSectionHeader}>
                <span style={styles.labelingSectionTitleKC}>KC 인증 시 추가 항목</span>
                <span style={styles.labelingSectionBadgeKC}>KC 필수</span>
              </div>
              <div style={styles.labelingList}>
